...
function VolumePricingTable({ tiers, currency, onTiersChange, onCurrencyChange, onAddTier, onRemoveTier, colors }) {
    ...
    return (
        <Box sx={{ mb: 3 }}>
            ...
            <Typography sx={{ fontSize: 12, color: colors.textSecondary, mb: 2 }}>
                Charge the same price for all units based on total quantity. All units are priced at the tier rate.
            </Typography>
