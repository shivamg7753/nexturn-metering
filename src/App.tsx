  ...
  useEffect(() => {
    ...
    const init = async () => {
      ...
      try {
        ...
        const realMetrics = meters.map((m: any) => ({
          id: m.id,
          name: m.name,
          code: m.code,
        ...
        realMetrics.forEach((m: any) => dispatch({ type: 'ADD_METRIC', payload: m }));
      } catch (e) {
      ...
      try {
        ...
        realCustomers.forEach((c: any) => dispatch({ type: 'ADD_CUSTOMER', payload: c }));
      } catch (e) {
      ...
      try {
        ...
        realPlans.forEach((p: any) => dispatch({ type: 'ADD_PLAN', payload: p }));
      } catch (e) {
      ...
      try {
        ...
        realSubscriptions.forEach((s: any) => dispatch({ type: 'ADD_SUBSCRIPTION', payload: s }));
      } catch (e) {
      ...
      try {
        ...
        realAddOns.forEach((a: any) => dispatch({ type: 'ADD_ADDON', payload: a }));
      } catch (e) {
